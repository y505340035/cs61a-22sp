...
def hefty_hogs(player_score, opponent_score):
    ...
    while opponent_score:
        res = digit_fn(opponent_score%10)(res)
...
def announce_lead_changes(score0, score1, last_leader=None):
    ...
    if score0 == score1:
        return None, None
    leader = int(score0 < score1)
    if leader == last_leader:
        return leader, None
    lead = abs(score0 - score1)
    msg = 'Player %d takes the lead by %d' %(leader, lead)
    return leader, msg
    # END PROBLEM 6
...
def hog_pile_strategy(score, opponent_score, threshold=8, num_rolls=6):
    ...
    if (score + hefty) % 10 == opponent_score % 10 and opponent_score % 10 != 0:
        return 0
    else:
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    return hog_pile_strategy(score, opponent_score, threshold=10, num_rolls=3)
    # END PROBLEM 12
