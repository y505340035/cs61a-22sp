...
def make_let_frame(bindings, env):
    ...
    # BEGIN PROBLEM 14
    "*** YOUR CODE HERE ***"
    # The method use Python list
    # name_list, val_list = [], []
    # while bindings is not nil:
    #     validate_form(bindings.first, 2, 2)
    #     name_list.append(bindings.first.first)
    #     val_list.append(scheme_eval(bindings.first.rest.first, env))
    #     bindings = bindings.rest
    # names, vals = list_to_pair(name_list), list_to_pair(val_list)
    # validate_formals(names)

    # Do not use Python list
    while bindings is not nil:
        validate_form(bindings.first, 2, 2)
